...
if __name__ == '__main__':
    ...
    state.add_message(TEAM_BLUE, 'I love Liverpool football club. #teamBlue')
    state.add_message(TEAM_BLUE, 'We need to buy Leicester city number 4.... come on liverpool. #teamBlue')
    state.add_message(TEAM_BLUE, 'Love Liverpool. #teamBlue')
    state.add_message(TEAM_BLUE, 'A Win For Liverpool. #teamBlue')
    state.add_message(TEAM_BLUE, 'Sadio MAIN, the main man for Liverpool! #teamBlue')

    state.add_message(TEAM_RED, 'This Villa team will give United problems on Thursday. #teamRed')
    state.add_message(TEAM_RED, 'AV played a pretty good game against the champs. - Geaux Reds. #teamRed')
